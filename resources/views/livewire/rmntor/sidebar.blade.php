<aside class="p-4 w-[316px]">
    <nav class="logo flex justify-center">
        <a href="/dashboard#">
            <span class="flex items-center justify-center logo-image h-16 aspect-square object-contain overflow-hidden rounded-xl">
    ...
    <nav x-data="{ open: false }" class="user-profile group flex flex-col items-center mt-6">
        <ul class="profile w-full p-[6px] bg-main/10 rounded-2xl overflow-hidden">
            <li class="user h-10 flex items-center">
                ...
                <span class="text name ml-1">Le Minerale</span>
            </li>
            <li x-show="open" x-transition class="user h-10 flex items-center hover:bg-danger/10 rounded-xl">
                <form class="w-full" action="/logout" method="post"> @csrf @method('DELETE')
                    <button class="flex items-center cursor-pointer w-full" type="submit">
                        ...
                        <span class="text name ml-1">Logout</span>
                    </button>
                </form>
            </li>
        </ul>
    ...
    <nav class="menu-group mt-4">
        <menu class="grid grid-flow-row gap-[6px]">
            <li>
                <a class="flex items-center" href="#">
                    ...
                    <span class="text name ml-2">Dashboard</span>
                </a>
            </li>
            <li>
                <a class="flex items-center group" href="#">
                    ...
                    <span class="text name ml-2 opacity-35 group-hover:opacity-100 transition-all">Tables</span>
                </a>
            </li>
        </menu>
    </nav>
